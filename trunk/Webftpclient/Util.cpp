...
//////////////////////////////////////////////////////////////////////////
#ifdef WIN32
void CUtil::GetFileList(const string& strTargetDirectoryPath, const string& strWildCard, bool bLookInSubdirectories, vector<string>& vecstrFileList)
{
	...
	string strCurrentDirectory = RemoveDirectoryEnding(strTargetDirectoryPath);
	...
	do 
	{
		...
		if(fdDesktop.dwFileAttributes & FILE_ATTRIBUTE_DIRECTORY)
		{
			...
			string strCurrentDirectoryName = GetDirectoryName(strPath);
			...
			// if(fdDesktop.dwFileAttributes & FILE_ATTRIBUTE_NORMAL)
		{
			...
			vecstrFileList.push_back(string(strPath));
		}
	}
